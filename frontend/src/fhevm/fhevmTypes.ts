...
import type { UserDecryptResults as RelayerSDKBundleUserDecryptResults } from "@zama-fhe/relayer-sdk/bundle";

export type { FhevmInstance, FhevmInstanceConfig, HandleContractPair };

// v0.3.0 renamed DecryptedResults to UserDecryptResults
export type UserDecryptResults = RelayerSDKBundleUserDecryptResults;
